...
"""
    dashglobe(;kwargs...)
    dashglobe(children::Any;kwargs...)
    dashglobe(children_maker::Function;kwargs...)
...
- `currentViewReportInterval` (Real; optional)
...
- `eventDataMode` (a value equal to: 'summary', 'full'; optional): Controls how much object data is included in click/hover payloads.
...
- `htmlElementScreenSide` (Bool | Real | String | Dict | Array; optional)
- `htmlElementScreenX` (Bool | Real | String | Dict | Array; optional)
- `htmlElementScreenY` (Bool | Real | String | Dict | Array; optional)
- `htmlElementTether` (Bool | Real | String | Dict | Array; optional)
- `htmlElementTetherAttach` (Bool | Real | String | Dict | Array; optional)
- `htmlElementTetherColor` (Bool | Real | String | Dict | Array; optional)
- `htmlElementTetherWidth` (Bool | Real | String | Dict | Array; optional)
...
- `largeDataMode` (Bool; optional): When true, apply performance defaults aimed at large datasets: disable
