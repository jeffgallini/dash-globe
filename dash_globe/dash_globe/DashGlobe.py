...
- eventDataMode (a value equal to: 'summary', 'full'; default 'summary'):
    Controls how much object data is included in click/hover payloads.
    Use \"summary\" (default) for large datasets so Dash only receives
    compact identifiers/properties instead of full geometries. Use
    \"full\" to preserve the complete object payload.
...
- largeDataMode (boolean; default False):
    When True, apply performance defaults aimed at large datasets:
    disable layer transitions, enable points merging when unset, and
    keep event payloads in summary mode.
...
- width (number; optional):
    ...
    def __init__(
        ...
        eventDataMode: typing.Optional[Literal["summary", "full"]] = None,
        largeDataMode: typing.Optional[bool] = None,
